...
function FeaturedCard() {
  ...
  const current = featuredSlides[currentIndex];

  return (
    <div
      onMouseEnter={() => setIsPaused(true)}
      onMouseLeave={() => setIsPaused(false)}
      className="col-span-1 lg:col-span-2 relative rounded-[2rem] overflow-hidden border border-white/10 transition-all duration-500 bg-[#0a0300] hover:border-white/20 hover:-translate-y-2 shadow-[0_8px_30px_rgb(0,0,0,0.5)] hover:shadow-[0_20px_40px_rgba(244,119,33,0.15)] group flex flex-col lg:flex-row min-h-[400px]"
    >
      ...
      {/* Text Content */}
      <div className="w-full lg:w-1/2 p-10 lg:p-16 flex flex-col justify-center relative z-10 min-h-[280px]">
        ...
        <div className="flex gap-2 mt-8 lg:mt-10">
          {featuredSlides.map((slide, i) => (
            <button
              ...
              className={`h-1.5 rounded-full transition-all duration-500 ${i === currentIndex ? "w-8 bg-[#f47721]" : "w-2 bg-white/30 hover:bg-white/60"
                }`}
            />
          ))}
        </div>
...
function SmallCard({ work }: { work: (typeof works)[0] }) {
  return (
    <Link href="/works" className="col-span-1 relative rounded-[2rem] overflow-hidden border border-white/10 transition-all duration-500 hover:border-[#f47721]/50 hover:-translate-y-2 shadow-[0_8px_30px_rgb(0,0,0,0.5)] hover:shadow-[0_20px_40px_rgba(244,119,33,0.2)] min-h-[400px] group cursor-pointer block">
...
export default function WorkShowcaseSection() {
  ...
  return (
    <section
      className="py-16 lg:py-24 bg-cover bg-center bg-no-repeat relative overflow-hidden transition-colors duration-300 bg-white/95 dark:bg-[#0a192f]/95 bg-blend-overlay"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
          ...
          <div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase text-slate-500 dark:text-gray-400 mb-4 md:mb-6"
            >
              WORK SHOWCASE
            </motion.div>
            ...
            <motion.h2
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-medium leading-[1.1] tracking-tight text-slate-900 dark:text-white"
            >
          ...
          <div className="flex flex-col justify-start pt-2 lg:pt-12">
            <motion.p
              ...
              className="text-slate-600 dark:text-gray-300 text-lg md:text-xl leading-relaxed mb-12 max-w-xl text-justify hyphens-auto"
            >
